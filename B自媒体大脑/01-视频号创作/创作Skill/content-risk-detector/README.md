...
Use the root [SKILL.md](知识库/B自媒体大脑/短视频方法库/内容质量检测类/content-risk-detector/SKILL.md) as the portable skill definition, and keep [AGENTS.md](知识库/B自媒体大脑/短视频方法库/内容质量检测类/content-risk-detector/AGENTS.md) at the repo root for repo-aware agents.
...
See [CONTRIBUTING.md](知识库/B自媒体大脑/短视频方法库/内容质量检测类/content-risk-detector/CONTRIBUTING.md).
