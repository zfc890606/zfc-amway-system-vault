...
2. **Pick a theme.** Open the deck and press `T` to cycle. Or hard-code it:
   ...
   ```
   Catalog in [references/themes.md](知识库/B自媒体大脑/短视频方法库/html-ppt-skill/references/themes.md).
...
- [references/themes.md](知识库/B自媒体大脑/短视频方法库/html-ppt-skill/references/themes.md) — all 36 themes with when-to-use.
