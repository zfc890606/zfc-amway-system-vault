...
**协议：** MIT
**English docs:** [README.md](skills/html-ppt-skill/README.md)

![html-ppt 封面 · 实时预览](hero.gif)
...
![演讲者模式 · 4 个磁吸卡片](presenter-mode.png)
...
详见 [`references/presenter-mode.md`](presenter-mode.md)，或直接复制
...
![31 种布局通过真实模板文件自动循环播放](layouts-live.gif)

*大 iframe 直接加载 `templates/single-page/<name>.html` 文件，每 2.8 秒
自动切换到下一个布局。*

![47 个动效 · 27 CSS + 20 Canvas FX](animations.png)
