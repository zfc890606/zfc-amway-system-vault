...
For domain-specific framing (startup, tech architecture, crisis response, etc.), see [references/scenario-templates.md](scenario-templates.md).
...
| File | Purpose |
| ---- | ------- |
| [references/scenario-templates.md](scenario-templates.md) | Domain-specific templates (startup, tech, finance, crisis, etc.) and probability calibration |
