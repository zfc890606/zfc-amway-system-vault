...
[references/onekgpd_commands.md](onekgpd_commands.md).
...
See [references/onekgpd_commands.md](onekgpd_commands.md) for full
...
-   [references/onekgpd_commands.md](onekgpd_commands.md) — full
    per-command argument tables and the returned-variant output schema.
-   [references/annotation_vocabularies.md](annotation_vocabularies.md)
