...
See [references/authentication.md](知识库/B自媒体大脑/短视频方法库/开发工具类/markitdown/skills/pyzotero/references/authentication.md) for full setup details.
...
| File | Contents |
|------|----------|
| [references/authentication.md](知识库/B自媒体大脑/短视频方法库/开发工具类/markitdown/skills/pyzotero/references/authentication.md) | Credentials, library types, local mode |
...
| [references/cli.md](知识库/B自媒体大脑/短视频方法库/开发工具类/markitdown/skills/pyzotero/references/cli.md) | Command-line interface (local Zotero 7) |
...
For searching a locally running Zotero desktop app (including full-text PDF search), use the CLI or MCP server instead of the Web API. Both require Zotero 7 with local API access enabled. See [references/cli.md](知识库/B自媒体大脑/短视频方法库/开发工具类/markitdown/skills/pyzotero/references/cli.md) and [references/mcp.md](mcp.md).
