...
**When NOT to use:** Informal task tracking (use [Kanban](知识库/B自媒体大脑/短视频方法库/开发工具类/markitdown/skills/markdown-mermaid-writing/references/diagrams/kanban.md)), general relationships (use [ER](er.md))
